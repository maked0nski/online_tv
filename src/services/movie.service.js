...
export const movieService = {
    ...
    getPersonById: ({id,queryString}) => axiosService.get(`${urls.person}/${id}`, {params: queryString}).then(value => value.data),

    getPersonExternalInfo: ({id,queryString}) => axiosService.get(`${urls.person}/${id}/external_ids`, {params: queryString}).then(value => value.data),
    getCombined_credits: ({id,queryString}) => axiosService.get(`${urls.person}/${id}/combined_credits`, {params: queryString}).then(value => value.data),
